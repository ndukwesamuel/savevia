...
export const RequestsStackNavigator = () => {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="RequestDetails" component={BloodRequestDetailsScreen} />
            <Stack.Screen name="EligibilityQuestionnaire" component={EligibilityQuestionnaireScreen} />
            <Stack.Screen name="EligibilityConfirmed" component={EligibilityConfirmedScreen} />
